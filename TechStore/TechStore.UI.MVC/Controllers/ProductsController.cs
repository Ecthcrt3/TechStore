    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var product = await _context.Products
                ...
                .Include(p => p.RestockLevelNavigation)
        ...
        public IActionResult Create()
        {
            ...
            ViewData["RestockLevel"] = new SelectList(_context.Restocks, "RestockLevel", "RestockLevel");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductDescription,CategoryId,ProductPrice,UnitsInStock,RestockLevel,ProductImage,Image")] Product product)
        {
            if (ModelState.IsValid)
            {
                ...
                if (product.Image != null)
                {
                    ...
                    if (validExts.Contains(ext.ToLower()) && product.Image.Length < 4_194_303)//underscores don't change the number, they just make it easier to read
                    {
                        ...
                        string fullImagePath = webRootPath + "/assets/";
            ...
            ViewData["RestockLevel"] = new SelectList(_context.Restocks, "RestockLevel", "RestockLevel", product.RestockLevel);
            return View(product);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductDescription,CategoryId,ProductPrice,UnitsInStock,RestockLevel,ProductImage,Image")] Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (product.Image != null)
                {
                    ...
                    if (validExts.Contains(ext.ToLower()) && product.Image.Length < 4_194_303)
                    {
                        ...
                        string webRootPath = _webHostEnvironment.WebRootPath;
                        string fullPath = webRootPath + "/assets/";
